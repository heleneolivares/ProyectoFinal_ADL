                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown d-lg-none">
                                ...
                                <ul className={`dropdown-menu ${darkMode ? "bg-dark text-light" : "bg-light text-dark"}`} aria-labelledby="categoryDropdown">
                                    ...
                                    <li><Link className="dropdown-item" to="#">VideoGames</Link></li>
                                    <li><Link className="dropdown-item" to="#">Series</Link></li>
                                    <li><Link className="dropdown-item" to="#">Anime</Link></li>
                                    <li><Link className="dropdown-item" to="#">Sport</Link></li>
                                    <li><Link className="dropdown-item" to="#">Music</Link></li>
                                    <li><Link className="dropdown-item" to="#">Pokemon</Link></li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div className="container-fluid d-none d-lg-block">
                <div className={`navbar navbar-expand-lg ${darkMode ? "bg-dark navbar-dark" : "bg-light navbar-light"}`}>
                    <ul className="navbar-nav w-100 d-flex justify-content-between">
                        ...
                        <li className="nav-item"><Link className="nav-link" to="#">VideoGames</Link></li>
                        <li className="nav-item"><Link className="nav-link" to="#">Series</Link></li>
                        <li className="nav-item"><Link className="nav-link" to="#">Anime</Link></li>
                        <li className="nav-item"><Link className="nav-link" to="#">Sport</Link></li>
                        <li className="nav-item"><Link className="nav-link" to="#">Music</Link></li>
                        <li className="nav-item"><Link className="nav-link" to="#">Pokemon</Link></li>
                    </ul>
                </div>
            </div>
